...
body {
  ...
  background: linear-gradient(135deg, #ffe0f0, #ffd1b3);
  display:flex;
...
@keyframes bgGradient {
  0% {background: linear-gradient(135deg, #ffe0f0, #ffd1b3);}
  50% {background: linear-gradient(135deg, #ffdfc9, #ffb3c1);}
  100% {background: linear-gradient(135deg, #ffe0f0, #ffd1b3);}
}
body { animation: bgGradient 15s ease infinite; }
...
<!-- Add this after the image gallery and before the audio-container -->
  ...
  <table class="message-table">
    ...
    <tbody>
      <tr>
        ...
        <td>
        <audio controls>
          <source src="mamaaa.mp3" type="audio/mpeg">
...
<td>
       ...
       <tr>
        <td>Nanosaa</td>
        <td contenteditable="true">ما شاء الله ربنا يحفظها ويحميها ويفرح قلوبنا بيها دايما يارب الصور كلها حلوة اوى ما شاء الله كل سنة وانتى طيبة يا حبيبت خالتو وبخير عقبال مليون سنه وتحققى كل لتتمنيه ❤😍</td>
        <td>
        <audio controls>
          <source src="mom-message.mp3" type="audio/mpeg">
          Your browser does not support the audio element.
